...
class RiceBagDetector:
    def __init__(self, model_path, detection_line_position=0.5, is_vertical=True):
        ...
        if self.device.type != 'cpu':
            self.model.fuse()   # Fuse layers for GPU inference
    ...
    def process_frame(self, frame):
        ...
        try:
            ...
            # Resize the frame to 416x416 for faster processing
            ...
            for box in results.boxes:
                ...
                if class_label == 0:  # Assuming class 0 is 'bag'
                    ...
                    x_min = int(x_min * native_width / 416)
                    x_max = int(x_max * native_width / 416)
                    y_min = int(y_min * native_height / 416)
                    y_max = int(y_max * native_height / 416)
